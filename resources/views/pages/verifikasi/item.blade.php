    ...
    <?php
        ...
        $column = json_encode([
            ...
            'purchase_group'=>[ 'name'=>"Purchasing Group", 'type'=>'Select', 'api'=>'pgroup', 'val'=>['purchase_group','purchase_group_desc'], 'req'=> true ],
                'material_no'=>[ 'if'=>['item_category',3,false], 'name'=>"Material Number", 'type'=>'TextSel', 'api'=>'mnumber', 'full'=>true, 'val'=>['material_group','material_desc'], 'share'=>['material_desc'=>0,'material_group'=>0,'uom'=>0,'uoms'=>['unit_measurement','unit_measurement_desc']],'req'=> true ],
                'short_text'=>[ 'if'=>['item_category',3,false], 'name'=>'Short Text', 'type'=>'Reference', 'full'=>true, 'key'=>'material_no', 'val'=>'material_desc'],
                'material_group'=>[ 'if'=>['item_category',3,false], 'name'=>"Material Group", 'type'=>'Reference', 'key'=>'material_no', 'val'=>'material_group'],
                ...
                '_unit_qty'=>[ 'if'=>[ 'item_category',3,true], 'name'=>"Unit of Measure", 'type'=>'TextSel', 'api'=>'umeasure', 'val'=>['unit_measurement','unit_measurement_desc'] ,'class'=>'hidden', 'def'=>17],
            ...
            'seq_no'=>[ 'type'=>'Static', 'def'=> (is_array(json_decode($data)) ? 10+sizeof($data)*10 : $data['seq_no']), 'class'=>'hidden'],
