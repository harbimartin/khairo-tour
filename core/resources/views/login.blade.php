            ...
            <div class="p-4 rounded-md shadow-xl border md:w-2/6 w-full md:mx-0 mx-2">
                ...
                <form class="w-full mt-10" action="/user/login" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input class="bg-gray-100 appearance-none border-2 border-gray-200 rounded w-full pb-2 pt-1 px-2 text-gray-700 leading-tight focus:outline-none text-sm w-full focus:bg-white focus:border-blue-400 form-control" id="nik" type="text" name="nik" placeholder="Masukan nik">
                    </div>
                    @if($errors->has('nik'))
