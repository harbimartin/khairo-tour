...
@section('md_content')
        ...
        $column = json_encode([
            ...
            'price_proposed'=>[ 'if'=>[ 'item_category',3,false], 'name'=>"Unit Price", 'type'=>'Number', 'count'=>'total', 'req'=> false ],
        ...
        $column_table = json_encode([
            ...
            'total_proposed'=>[ 'name'=>"Price Proposed", 'type'=>'Money'],
            'total_verified'=>[ 'name'=>"Price Verified", 'type'=>'Money'],
